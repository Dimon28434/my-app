...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView selectedTopicNaem = findViewById(R.id.selectedTopicName);
        ...
        selectedTopicNaem.setText(getSelectedTopic);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedOptionByUser.isEmpty()) {
                    Toast.makeText(QuizActivity.this, "Виберіть одну відповідь!", Toast.LENGTH_SHORT).show();
                } else  {
                    changeNextQuestion();
                }
            }
    ...
    private  void changeNextQuestion () {
        ...
        if ((currentQuestionPosition+1) == questionsList.size()) {
            nextBtn.setText("Завершено");
        }
        if (currentQuestionPosition < questionsList.size()) {
            selectedOptionByUser = "";
            option1.setBackgroundResource(R.drawable.round_back);
            option1.setTextColor(Color.parseColor("#1F6BB8"));

            option2.setBackgroundResource(R.drawable.round_back);
            option2.setTextColor(Color.parseColor("#1F6BB8"));

            option3.setBackgroundResource(R.drawable.round_back);
            option3.setTextColor(Color.parseColor("#1F6BB8"));

            option4.setBackgroundResource(R.drawable.round_back);
